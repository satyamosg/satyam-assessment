...
const appRoutes: Routes = [
  ...
  { path: 'present-list', component: PresentListComponent, canActivate: [AuthGuardService] },
  { path: 'letter-list', component: LetterListComponent, canActivate: [AuthGuardService] }
];
